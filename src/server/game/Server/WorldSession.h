...
class TC_GAME_API WorldSession
{
    ...
    public:                                                 // opcodes handlers
        ...
        void HandleMythicPlusRequestMapStats(WorldPackets::ChallengeMode::Misc&);
        ...
        void HandleResetChallengeModeCheat(WorldPackets::ChallengeMode::ResetChallengeMode& packet);
        // Warden
