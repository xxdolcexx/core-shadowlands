...
namespace WorldPackets
{
    namespace ChallengeMode
    {
        ...
        {
        public:
            ChangePlayerDifficultyResult(uint32 type = 0) : ServerPacket(SMSG_CHANGE_PLAYER_DIFFICULTY_RESULT, 1 + 1 + 4 + 4 + 4 + 4 + 16) { }
        ...
        {
        public:
            ChallengeModeMapStatsUpdate() : ServerPacket(SMSG_WEEKLY_REWARDS_RESULT, 12) { } //idk if is SMSG_WEEKLY_REWARDS_RESULT
