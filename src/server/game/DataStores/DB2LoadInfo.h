...
struct MythicPlusSeasonLoadInfo
{
    static DB2LoadInfo const* Instance()
    {
        ...
        {
            {true, FT_INT, "ID"},
            {true, FT_INT, "SubSeason"},
            {true, FT_INT, "ExpansionLevel"},
            {true, FT_INT, "SomeItemLevel"},
        };
        static DB2LoadInfo const loadInfo(&fields[0], std::extent<decltype(fields)>::value, MythicPlusSeasonMeta::Instance(), HOTFIX_SEL_MYTHIC_PLUS_SEASON);
        return &loadInfo;
    }
};
...
struct MythicPlusSeasonRewardLevelsLoadInfo
{
    static DB2LoadInfo const* Instance()
    {
        ...
        {
            {true, FT_INT, "ID"},
            {true, FT_INT, "DifficultyLevel"},
            {true, FT_INT, "WeaklyRewardLevel"},
            {true, FT_INT, "EndOfRunRewardLevel"},
            {true, FT_INT, "MythicPlusSeasonID"},
        };
        static DB2LoadInfo const loadInfo(&fields[0], std::extent<decltype(fields)>::value, MythicPlusSeasonRewardLevelsMeta::Instance(), HOTFIX_SEL_MYTHIC_PLUS_SEASON_REWARD_LEVELS);
        return &loadInfo;
    }
};
...
struct MythicPlusSeasonTrackedAffixLoadInfo
{
    static DB2LoadInfo const* Instance()
    {
        static DB2FieldMeta const fields[] =
        {
            ...
            {true, FT_INT, "Field_9_1_0_38511_003"},
            {true, FT_INT, "Field_9_1_0_38511_004"},
            {true, FT_INT, "DisplaySeasonID"},
        };
        static DB2LoadInfo const loadInfo(&fields[0], std::extent<decltype(fields)>::value, MythicPlusSeasonTrackedAffixMeta::Instance(), HOTFIX_SEL_MYTHIC_PLUS_SEASON_TRACKED_AFFIX);
        return &loadInfo;
    }
};
